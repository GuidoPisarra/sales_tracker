...
class PreciosController extends BaseController
{
    ...
    public function desactualizados(int $id_negocio, PreciosService $precios_service): JsonResponse
    {
        ...
        try {
            $resultado = $precios_service->obtenerPreciosDesactualizados($id_negocio);
